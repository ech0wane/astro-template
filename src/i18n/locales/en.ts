...
const baseStrings = {
  ...
  "site.desc": "A minimal, responsive blog template",
};
...
const ENLocale: I18nStrings = {
  ...
  "hero.title": "Welcome",
  "hero.body":
    "A clean, responsive bilingual blog template built with Astro, Tailwind CSS, and Markdown.",
  "hero.beforeReadme": "",
  "hero.buyCoffee": "",
  "hero.afterReadme":
  ...
  about: "About",
  authors: "Authors",
  "authors.desc": "All authors",
  projects: "Projects",
  "projects.desc": "Projects and repositories",
  "projects.repo": "View",
  ...
  archives: "Archives",
  "archives.desc": "All articles by date",
  "archives.empty": "No posts yet.",
  "archives.post": "post",
  "archives.posts": "posts",
  "archives.jumpTo": "Jump to year",
  featured: "Featured",
